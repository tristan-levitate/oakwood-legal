...
export class PracticeAreaSlugConfig extends BasePageConfig {
  public getConfig(): PageHeroConfig {
    return {
      ...
      verticalBorder: {
        ...
        ariaLabel: 'Practice area page message background border',
      ...
      sectionTitle: 'Practice Area Hero Section'
    };
  }
}
