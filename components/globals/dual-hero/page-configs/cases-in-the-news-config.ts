...
export class CasesInTheNewsConfig extends BasePageConfig {
  public getConfig(): PageHeroConfig {
    return {
      ...
      verticalBorder: {
        ...
        ariaLabel: 'Cases in the news message background border',
      ...
      sectionTitle: 'Cases in the News Hero Section'
    };
  }
}
