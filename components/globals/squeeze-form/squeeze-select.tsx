...
export default function SqueezeSelect({
  name,
  label,
  placeholder,
  options,
  ...
  return (
    <div className={`relative w-full pt-4 max-[559px]:pb-6 ${className}`}>
      ...
      <div
        ...
        className={`w-full bg-transparent text-sm pb-2 pt-3 border-0 border-b-1 cursor-pointer transition-all duration-200 pr-8 ${
      ...
      {/* Label */}
      <label
        className="absolute left-0 top-0 text-[rgba(255,255,255,0.7)] text-sm font-helvetica font-normal leading-[1.4] capitalize transition-all duration-200 z-10 pointer-events-none"
      >
        {label}
      </label>

      {/* Custom dropdown arrow */}
      <div className="absolute right-2 top-1/2 transform -translate-y-1/2 pointer-events-none max-[559px]:top-[40%]">
        <svg
